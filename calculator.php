...
if (isset($_GET["num1"], $_GET["num2"], $_GET["num3"], $_GET["operator"])) {
    $num1 = $_GET["num1"];
    $num2 = $_GET["num2"];
    $num3 = $_GET["num3"]; // Get the third number
    $op = $_GET["operator"];
    $result = "";

    switch ($op) {
        case "add":
            $result = $num1 + $num2 + $num3; // Add all three
            break;
        case "subtract":
            $result = $num1 - $num2 - $num3; // Subtract all three
            break;
        case "multiply":
            $result = $num1 * $num2 * $num3; // Multiply all three
            break;
        case "divide":
            // Handle division by zero for any divisor
            if ($num2 != 0 && $num3 != 0) {
    ...
    // Store in session history.  Adjusted to include the third number.
